...
with open('taxonomies_list.json') as data_file:
...
save_path='./saved_models_just_taxonomies'
...
model.keras_model.save(os.path.join(save_path,'trained_model_just_taxonomies.h5'))