...
with open('labels_with_taxonomies.json') as data_file:
...
# magpie_mongo.utils.save_to_disk('./scalar/scalar_with_taxonomies', model.scaler, overwrite=True)
save_path='./saved_models_with_taxonomies'
...
model.keras_model.save(os.path.join(save_path,'trained_model_with_taxonomies.h5'))
